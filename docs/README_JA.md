...
- ✅ **表面法線**: 写真内の人物のピクセル単位法線マップ。
- ✅ **人物マッティング**: 人物前景を透過 PNG として切り抜き。
...
- [tongflow-modal-sapiens2](https://github.com/tong-io/tongflow-modal-sapiens2) — Sapiens2（Meta）人体スイート：ポーズ検出、身体部位セグメンテーション、表面法線、人物マッティング、画像 → 3D 点群、**動画モーションキャプチャ**（身体・指・表情チャンネル付きスケルタルアニメーション GLB）
