...
- [tongflow-modal-sapiens2](https://github.com/tong-io/tongflow-modal-sapiens2) — Sapiens2（Meta）人体套件：姿态检测、人体部位分割、表面法线、人像抠图、图像 → 3D 点云，以及**视频动作捕捉**（含身体、手指、表情通道的骨骼动画 GLB）
